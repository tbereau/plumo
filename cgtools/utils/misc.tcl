...
# ::cgtools::utils::trap_mols --
#
# Apply molecular traps to all molecules specified in a list
#
# 
#
proc ::cgtools::utils::trap_mols { molstotrap } {
...
# topo : the topology
#
proc ::cgtools::utils::calc_com { mol } {
    set com " 0.0 0.0 0.0"
...
#
proc ::cgtools::utils::isoutside { pos zone } {
    set outside 1
    set inside 0
...
proc ::cgtools::utils::calc_centersofmass_bymoltype { moltypes topology } {
