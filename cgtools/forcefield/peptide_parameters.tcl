namespace eval peptideb {
    ...
    variable lb_NCa  [sum $rvdw_N $rvdw_Ca] 
    variable lb_NC   [sum $rvdw_N $rvdw_C ] 
    variable lb_CaC  [sum $rvdw_Ca $rvdw_C ] 
    ...
    # Angles (in Radians)
    variable angleR_NCaCb  [deg2rad $angleD_NCaCb ]
    variable angleR_CbCaC  [deg2rad $angleD_CbCaC ]
    variable angleR_NCaC   [deg2rad $angleD_NCaC  ]
    variable angleR_CaCN   [deg2rad $angleD_CaCN  ]
    variable angleR_CNCa   [deg2rad $angleD_CNCa  ]
    variable angleR_CaCO   [deg2rad $angleD_CaCO  ]
    variable angleR_NCaCO  [deg2rad $angleD_NCaCO ]
    variable angleR_CaNHN  [deg2rad $angleD_CaNHN ]
    variable angleR_CCaNHN [deg2rad $angleD_CCaNHN]
    variable angleR_Im_Cb  [deg2rad $angleD_Im_Cb ]
