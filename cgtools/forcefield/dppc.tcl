...
set beadlist [list 0 1 2 3 5 5 5 5 7 4 5 5 5 5 7 ]
# list of bonds:{bondid {bead1# bead2# in the bead lists}}
set bondlist [list { 0 { 0 1 } } { 1 { 1 2 } } { 2 { 2 3 } }  { 4 { 3 4 } } { 6 { 4 5 } } { 6 { 5 6 }} { 6 { 6 7 } } { 8 { 7 8 } } { 3 { 2 9 } } { 5 { 9 10 } } { 6 { 10 11 } } { 6 { 11 12 } } { 6 { 12 13 } } { 8 { 13 14 } } { 9 { 3 9 } } { 10 { 0 2 } } { 11 { 1 3 } } { 13 { 2 4 } } { 15 { 3 5 } } { 17 { 4 6 } } { 17 { 5 7 } } { 20 { 6 8 } } { 12 { 1 9 } } { 14 { 2 10 } } { 16 { 9 11 } } { 17 { 10 12 } } { 17 { 11 13 } } { 20 { 12 14 } } ]
# list of angls:{bondid {bead1# bead2# bead3# in the bead lists}}
set angllist [list ]
# list of dihes:{bondid {bead1# bead2# bead3# bead4# in the bead lists}} 
set dihelist [list ]
lappend dppclist $beadlist
lappend dppclist $bondlist
lappend dppclist $angllist
lappend dppclist $dihelist
unset beadlist
unset bondlist
unset angllist
unset dihelist
...
lappend dppctypelist $beadtypelist
lappend dppctypelist $bondtypelist
lappend dppctypelist $angltypelist
lappend dppctypelist $dihetypelist
lappend dppctypelist $nonbtypelist
unset beadtypelist
unset bondtypelist
unset angltypelist
unset dihetypelist
...
set charmmbeadlist [list { 0 CH } { 1 PH } { 2 GL } { 3 ES1 } { 4 AS11 } { 5 AS12 } { 6 AS13 } { 7 AS14 } { 8 AE15 } { 9 ES2 } { 10 AS21 } { 11 AS22 } { 12 AS23 } { 13 AS24 } { 14 AE25 } ]
lappend dppccharmmbeadlist $charmmbeadlist
unset charmmbeadlist

#moltypeid
lappend moldppclist "0" 
#molspec
lappend moldppclist "DPPC" 
#
lappend moldppclist $dppclist 
lappend moldppclist $dppctypelist 
lappend moldppclist $dppccharmmbeadlist 
unset dppclist
unset dppctypelist
unset dppccharmmbeadlist
lappend moltypelists $moldppclist
::mmsg::send [namespace current] "moldppclist is set"
...
set partbondnamelist [lindex $moldppclist 3]
