# 72 POPC bilayer with WALP 23 peptide.
# FEP calculation for free energy of insertion of WALP in membrane.
# Script calculates one lambda window. Sum over all lambdas from 0 to 1
# to get free energy.
#
...
set ident "hydr-$lambdai-$lambdaj"
set outputdir "./$ident"
...
lappend analysis_flags "fep $lambdai $lambdaj"
